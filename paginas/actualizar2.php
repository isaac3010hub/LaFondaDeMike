...
<body background="/src/img/carrtioMenu.PNG">
    ...
    <form method="POST" class="mikeindex formulariocp2" action="">
        <h1>Actualizar</h1>
            <input type ="text-input" placeholder="DISTRIBUIDORA:" required>
            <input type ="text-input" placeholder="PRECIO:" required>
            <textarea name="" id="" cols="30" rows="10">INGREDIENTES:</textarea>
        <div class="mikepijo">
            <div class="boton">
                <a href="">ENVIAR</a>
            </div>
            <div class="boton mikeeo">
                <a href="">ELIMINAR</a>
            </div>
        </div>
